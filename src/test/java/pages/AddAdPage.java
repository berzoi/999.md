...
public class AddAdPage extends BaseTest {
  ...
  private final String textCarToAdd = "Skoda Fabia 3 \n"
      + "- 2019 г.в.\n"
      + "- 22.800 км.\n"
      + "- 999cm\n"
  ...
  private final String textSSDToAddTitle = "Новый Kingston NV2 500Gb, PCIe 4.0";
  ...
  public void logitech(){
    ...
    page.fill(title, "Logitech - Оригинальный чехол для компьютерной мыши");
    page.fill(price, "50");
  ...
  public void orico(){
    ...
    page.fill(adTextForm, "— Внешний корпус для жесткого диска/SSD ORICO, Type C, USB 3.1 Gen 2, 2.5\" — 400 лей\n"
        + "— Samsung 850 Evo 120Gb — 200 лей");
  ...
  public void addSDD(){
    ...
    page.setInputFiles(uploadPictureButton, Path.of("G:\\My Drive\\999\\SSD\\IMG20230407102433.jpg"));
  ...
  public void addCar() {
    ...
    page.fill(adTextForm, textCarToAdd);
